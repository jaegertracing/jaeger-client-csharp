...
namespace Jaeger.Thrift.Agent.Zipkin
{
  public partial class ZipkinCollector
  {
    ...
    {
      Task<List<Response>> submitZipkinBatchAsync(List<Span> spans, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public class Client : TBaseClient, IDisposable, IAsync
    {
      ...
      public async Task<List<Response>> submitZipkinBatchAsync(List<Span> spans, CancellationToken cancellationToken = default(CancellationToken))
      {
    ...
    public partial class submitZipkinBatchArgs : TBase
    {
                ...
                {
                  {
                    ...
                    Spans = new List<Span>(_list8.Count);
      ...
      {
        var other = that as submitZipkinBatchArgs;
    ...
    public partial class submitZipkinBatchResult : TBase
    {
                ...
                {
                  {
                    ...
                    Success = new List<Response>(_list12.Count);
      ...
      public override bool Equals(object that)
      {
        var other = that as submitZipkinBatchResult;
        if (other == null) return false;
        if (ReferenceEquals(this, other)) return true;
