...
namespace Jaeger.Thrift.Agent
{
  public partial class Agent
  {
    ...
    {
      Task emitZipkinBatchAsync(List<Jaeger.Thrift.Agent.Zipkin.Span> spans, CancellationToken cancellationToken = default(CancellationToken));

      Task emitBatchAsync(Jaeger.Thrift.Batch batch, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public class Client : TBaseClient, IDisposable, IAsync
    {
      ...
      public async Task emitZipkinBatchAsync(List<Jaeger.Thrift.Agent.Zipkin.Span> spans, CancellationToken cancellationToken = default(CancellationToken))
      {
      ...
      public async Task emitBatchAsync(Jaeger.Thrift.Batch batch, CancellationToken cancellationToken = default(CancellationToken))
      {
    ...
    public partial class emitZipkinBatchArgs : TBase
    {
                ...
                {
                  {
                    ...
                    Spans = new List<Jaeger.Thrift.Agent.Zipkin.Span>(_list0.Count);
      ...
      {
        var other = that as emitZipkinBatchArgs;
    ...
    public partial class emitBatchArgs : TBase
    {
      ...
      public override bool Equals(object that)
      {
        var other = that as emitBatchArgs;
        if (other == null) return false;
        if (ReferenceEquals(this, other)) return true;
