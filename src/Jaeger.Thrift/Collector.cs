...
namespace Jaeger.Thrift
{
  public partial class Collector
  {
    ...
    {
      Task<List<BatchSubmitResponse>> submitBatchesAsync(List<Batch> batches, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class submitBatchesArgs : TBase
    {
      ...
      {
        var other = that as submitBatchesArgs;
    ...
    public partial class submitBatchesResult : TBase
    {
      ...
      public override bool Equals(object that)
      {
        var other = that as submitBatchesResult;
        if (other == null) return false;
        if (ReferenceEquals(this, other)) return true;
