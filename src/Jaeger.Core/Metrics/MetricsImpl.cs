...
namespace Jaeger.Core.Metrics
{
    public class MetricsImpl : IMetrics
    {
        ...
        /// <inheritdoc/>
        [Metric(name: "traces", tag1Key: "state", tag1Value: "started", tag2Key: "sampled", tag2Value: "n")]
        public ICounter TraceStartedNotSampled { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "traces", tag1Key: "state", tag1Value: "joined", tag2Key: "sampled", tag2Value: "y")]
        public ICounter TracesJoinedSampled { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "traces", tag1Key: "state", tag1Value: "joined", tag2Key: "sampled", tag2Value: "n")]
        public ICounter TracesJoinedNotSampled { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "started_spans", tag1Key: "sampled", tag1Value: "y")]
        public ICounter SpansStartedSampled { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "started_spans", tag1Key: "sampled", tag1Value: "n")]
        ...
        /// <inheritdoc/>
        [Metric(name: "reporter_spans", tag1Key: "result", tag1Value: "ok")]
        public ICounter ReporterSuccess { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "reporter_spans", tag1Key: "result", tag1Value: "err")]
        public ICounter ReporterFailure { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "reporter_spans", tag1Key: "result", tag1Value: "dropped")]
        ...
        /// <inheritdoc/>
        [Metric(name: "sampler_queries", tag1Key: "result", tag1Value: "ok")]
        public ICounter SamplerRetrieved { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "sampler_queries", tag1Key: "result", tag1Value: "err")]
        public ICounter SamplerQueryFailure { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "sampler_updates", tag1Key: "result", tag1Value: "ok")]
        public ICounter SamplerUpdated { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "sampler_updates", tag1Key: "result", tag1Value: "err")]
        public ICounter SamplerParsingFailure { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "baggage_updates", tag1Key: "result", tag1Value: "ok")]
        public ICounter BaggageUpdateSuccess { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "baggage_updates", tag1Key: "result", tag1Value: "err")]
        ...
        /// <inheritdoc/>
        [Metric(name: "baggage_restrictions_updates", tag1Key: "result", tag1Value: "ok")]
        public ICounter BaggageRestrictionsUpdateSuccess { get; private set; }

        /// <inheritdoc/>
        [Metric(name: "baggage_restrictions_updates", tag1Key: "result", tag1Value: "err")]
