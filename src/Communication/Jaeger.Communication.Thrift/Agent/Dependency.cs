...
namespace Jaeger.Thrift.Agent
{
  public partial class Dependency
  {
    ...
    {
      Task<Dependencies> getDependenciesForTraceAsync(string traceId, CancellationToken cancellationToken = default(CancellationToken));

      Task saveDependenciesAsync(Dependencies dependencies, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public class Client : TBaseClient, IDisposable, IAsync
    {
      ...
      public async Task<Dependencies> getDependenciesForTraceAsync(string traceId, CancellationToken cancellationToken = default(CancellationToken))
      {
      ...
      public async Task saveDependenciesAsync(Dependencies dependencies, CancellationToken cancellationToken = default(CancellationToken))
      {
    ...
    public partial class getDependenciesForTraceArgs : TBase
    {
      ...
      {
        var other = that as getDependenciesForTraceArgs;
    ...
    public partial class getDependenciesForTraceResult : TBase
    {
      ...
      public override bool Equals(object that)
      {
        var other = that as getDependenciesForTraceResult;
        if (other == null) return false;
        if (ReferenceEquals(this, other)) return true;
    ...
    public partial class saveDependenciesArgs : TBase
    {
      ...
      public override bool Equals(object that)
      {
        var other = that as saveDependenciesArgs;
        if (other == null) return false;
        if (ReferenceEquals(this, other)) return true;
