...
namespace Jaeger.Thrift.Agent
{
  public partial class BaggageRestrictionManager
  {
    public interface IAsync
    {
      ...
      Task<List<BaggageRestriction>> getBaggageRestrictionsAsync(string serviceName, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public class Client : TBaseClient, IDisposable, IAsync
    {
      ...
      public async Task<List<BaggageRestriction>> getBaggageRestrictionsAsync(string serviceName, CancellationToken cancellationToken = default(CancellationToken))
      {
    ...
    public partial class getBaggageRestrictionsArgs : TBase
    {
      ...
      {
        var other = that as getBaggageRestrictionsArgs;
    ...
    public partial class getBaggageRestrictionsResult : TBase
    {
      ...
      public override bool Equals(object that)
      {
        var other = that as getBaggageRestrictionsResult;
        if (other == null) return false;
        if (ReferenceEquals(this, other)) return true;
