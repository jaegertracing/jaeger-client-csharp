...
namespace Jaeger.Thrift.Agent.Zipkin
{
  ...
  public partial class Endpoint : TBase
  {
    ...
    public Endpoint DeepCopy()
    {
      ...
      tmp0.__isset.ipv4 = this.__isset.ipv4;
      if(__isset.port)
      {
        tmp0.Port = this.Port;
      }
      ...
      {
        tmp0.Service_name = this.Service_name;
      }
      tmp0.__isset.service_name = this.__isset.service_name;
      if((Ipv6 != null) && __isset.ipv6)
      {
        tmp0.Ipv6 = this.Ipv6.ToArray();
      }
      tmp0.__isset.ipv6 = this.__isset.ipv6;
      return tmp0;
    }
