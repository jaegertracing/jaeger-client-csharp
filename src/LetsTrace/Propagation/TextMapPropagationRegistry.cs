...
namespace LetsTrace.Propagation
{
    ...
    {
        private static readonly IHeadersConfig DefaultHeadersConfig = new HeadersConfig(Constants.TRACE_CONTEXT_HEADER_NAME, Constants.TRACE_BAGGAGE_HEADER_PREFIX);
